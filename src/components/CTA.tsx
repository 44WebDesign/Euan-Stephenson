      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#contact" className="bg-white text-primary px-10 py-4 rounded-xl font-black uppercase text-sm hover:bg-white/90 transition-colors duration-300 tracking-wide cursor-pointer inline-block text-center">
              Partner with Euan
            </a>
            <a href="#contact" className="bg-background-dark text-white px-10 py-4 rounded-xl font-black uppercase text-sm hover:bg-background-dark/80 transition-colors duration-300 tracking-wide border border-white/10 cursor-pointer inline-block text-center">
              Get in Touch
            </a>
          </div>
        </div>
